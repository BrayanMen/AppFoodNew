...
function RecipeRate({ recipe }) {
    ...
    return (
        <div className='my-12 '>
            ...
            <div className='mt-10 xl:grid flex-colo grid-cols-5 text-white gap-12 bg-gray-500 xs:p-10 py-10 px-2 sm:p-20 rounded'>
                <div className='xl:col-span-2 w-full flex flex-col gap-8'>
                    <h3 className='text-2xl text-white font-semibold'>
                        Review "{recipe?.name}"
                    </h3>
                    <p className='text-sm leading-7 font-semibold text-gray-300  '>
                    ...
                    <button className='bg-secondary font-semibold border border-secondary hover:bg-opacity-50 text-white py-3 hover:text-white flex-colo rounded'>
                        Submit
                    </button>
                </div>
